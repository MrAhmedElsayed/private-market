...
<template>
  ...
  >
    <div class="relative p-6 pt-6 lg:pt-11 pb-9 bg-gray-100">
      <div class="flex flex-wrap -mx-4 gap-16">
        <div class="w-full lg:w-6/12 px-4">
          <div class="hero-content">
            <div
              class="relative mx-auto p-3 w-full max-w-lg bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700"
            >
              <!-- error alert -->
              <div
                v-if="alertError"
                class="absolute top-10 right-20 flex p-4 bg-red-100 rounded-lg dark:bg-red-200"
                role="alert"
              >
                <svg
                  aria-hidden="true"
              ...
              <form class="space-y-5" @submit.prevent="loginSubmit">
                <img
                  class="mx-auto"
        ...
        >
          ...
          <!-- footer -->
          <footer
            class="mt-auto bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800"
          >
            <p
